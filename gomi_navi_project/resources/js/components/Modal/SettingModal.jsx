    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white p-4 sm:p-8 rounded-lg shadow-lg max-w-xs sm:max-w-md w-full">
          ...
          <div className="border-b-2 sm:my-4"></div>
          <p className='text-base pt-2 text-center font-bold text-lg sm:text-xl'>地域を設定する</p>
          ...
          <div className='hidden sm:block'>
            <p className='text-base text-center font-bold text-lg sm:text-xl p-2 sm:p-4'>外部リマインダー連携</p>
            <LineButton
              text='LINEと連携する'
